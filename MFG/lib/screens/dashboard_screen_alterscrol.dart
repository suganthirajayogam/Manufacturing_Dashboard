...
class SettingsAwareDashboardsc extends StatefulWidget {
  const SettingsAwareDashboardsc({Key? key}) : super(key: key);

  @override
  _SettingsAwareDashboardState createState() => _SettingsAwareDashboardState();
}

class _SettingsAwareDashboardState extends State<SettingsAwareDashboardsc>
